...
class Fuel_social extends Fuel_advanced_module {

	public $name = "social"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->social->my_method()
	 */
}